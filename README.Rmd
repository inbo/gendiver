...
You can install the development version of gendiver from [GitHub](https://github.com/) with:
...
Read Operational Data from INBO Shared Google Drive (institutional access required)

```{r example-io, eval=FALSE}
library(gendiver)
